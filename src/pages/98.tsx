...
export default function IndexPage() {
  ...
  return (
    ...
    <div
      ref={ref}
      className="cpywindow oldschool h-[100vh] w-[100vw] bg-amber-400 overflow-hidden	"
    >
        ...
        <div className="start-menu bg fixed bottom-8 flex w-[200px] h-[300px] top">
          ...
          <div className="flex flex-col justify-end h-full w-[85%]">
            <button
              ...
              onClick={() => launchApp(TerminalViewWindow)}
            >
              <img
                src={console_prompt}
                alt="window icon"
            ...
            <button
              className="flex p-2 items-end"
              onClick={() => launchApp(IdeViewWindow)}
            >
              <img
                src={program_manager}
                alt="window icon"
            ...
            <button
              className="flex p-2 items-end"
              onClick={() => launchApp(SettingsViewWindow)}
            >
